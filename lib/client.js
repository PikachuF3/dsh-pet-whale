			...
			play(type) {
				...
				try {
					...
					if (type === "bubble") {
						...
						gain.gain.setValueAtTime(.3 * vol, now);
						...
						gain.gain.setValueAtTime(.18 * vol, now);
						...
						gain.gain.setValueAtTime(.2 * vol, now + i * .08);
						...
						gain.gain.setValueAtTime(.15 * vol, now);
						...
						gain.gain.setValueAtTime(.25 * vol, now);
						...
						gain.gain.setValueAtTime(.28 * vol, now);
  ...
  `;
			...
			try {
				...
				const applyMobileHide = () => {
					if (mobileMQ.matches) root.classList.add("hidden");
